...
export default function Model({ ...props }) {
  ...
  const frontRightWheelRef = useRef<THREE.Object3D>(null);
  const frontLeftWheelRef = useRef<THREE.Object3D>(null);
  const backRightWheelRef = useRef<THREE.Object3D>(null);
  const backLeftWheelRef = useRef<THREE.Object3D>(null);
